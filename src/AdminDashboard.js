                            ...
                            <ul className="package-list">
                                {(client.packages || []).map(pkg => {
                                    ...
                                    allOccurrences.forEach(occ => {
                                      if(!occ.isCancelled && new Date(occ.effectiveDate) < new Date()) {
                                        completedHours += occ.hoursBooked;
                                      }
                                    });
